 ...
 */
public class MonetaryValue implements Cloneable {
	...
	public MonetaryValue(long francs, long cents) {
		...
		if (francs < 0 && cents < 0 && cents == Long.MIN_VALUE) {
	 ...
	 * 
	 * @param other
	 *            The other {@code MonetaryValue} to add to this value
	...
	/**
	 * Adds multiple {@code MonetaryValue}s together
	 * 
	 * @param values
	 ...
	 *             if a long overflow occurs
	 */
	public static MonetaryValue sumAll(MonetaryValue... values) {
	...
	public String toString() {
		...
		out.append(value).insert(out.length() - 2, ".");
		return out.toString();
	}
}
